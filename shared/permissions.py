...
FEATURE_PERMISSION_MAP: Dict[str, FeaturePermission] = {
    ...
    "accounting.payment_requests.list": FeaturePermission(
        code="accounting.payment_requests.list",
    ...
    "sales.customers": FeaturePermission(
    ...
    "sales.settings": FeaturePermission(
        code="sales.settings",
    ...
    "procurement.orders.list": FeaturePermission(
        code="procurement.orders.list",
    ...
    "procurement.invoices.purchase": FeaturePermission(
        code="procurement.invoices.purchase",
    ...
    "procurement.services.request": FeaturePermission(
        code="procurement.services.request",
    ...
    # Procurement – Service Invoices
    "procurement.invoices.service": FeaturePermission(
        code="procurement.invoices.service",
        label=_("Service Invoices"),
        actions=[
            PermissionAction.VIEW_OWN,
            PermissionAction.VIEW_ALL,
            PermissionAction.VIEW_SAME_GROUP,
