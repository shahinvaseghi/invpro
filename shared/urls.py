...
urlpatterns = [
    ...
    path('units/<int:pk>/', views.CompanyUnitDetailView.as_view(), name='company_unit_detail'),
    ...
    path('access-levels/<int:pk>/', views.AccessLevelDetailView.as_view(), name='access_level_detail'),
    ...
    path('smtp-servers/<int:pk>/', views.SMTPServerDetailView.as_view(), name='smtp_server_detail'),
