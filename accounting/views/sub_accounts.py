...
class SubAccountListView(FeaturePermissionRequiredMixin, AccountingBaseView, ListView):
    ...
    def get_context_data(self, **kwargs: Any) -> Dict[str, Any]:
        ...
        context['feature_code'] = 'accounting.accounts.sub'
        context['detail_url_name'] = 'accounting:sub_account_detail'
...
class SubAccountDetailView(FeaturePermissionRequiredMixin, AccountingBaseView, DetailView):
    ...
    def get_context_data(self, **kwargs: Any) -> Dict[str, Any]:
        ...
        context = super().get_context_data(**kwargs)
        context['page_title'] = _('مشاهده حساب معین')
        context['list_url'] = reverse_lazy('accounting:sub_accounts')
        context['edit_url'] = reverse_lazy('accounting:sub_account_edit', kwargs={'pk': self.object.pk})
