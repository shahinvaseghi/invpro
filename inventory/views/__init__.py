...
from .requests import (
    ...
    PurchaseRequestCreateFromTransferRequestView,
...
if _views_py_path.exists():
    ...
    _exclude = {
        ...
        'ItemTypeListView', 'ItemTypeCreateView', 'ItemTypeDetailView', 'ItemTypeUpdateView', 'ItemTypeDeleteView',
        'ItemCategoryListView', 'ItemCategoryCreateView', 'ItemCategoryDetailView', 'ItemCategoryUpdateView', 'ItemCategoryDeleteView',
        'ItemSubcategoryListView', 'ItemSubcategoryCreateView', 'ItemSubcategoryDetailView', 'ItemSubcategoryUpdateView', 'ItemSubcategoryDeleteView',
        'ItemListView', 'ItemSerialListView', 'ItemCreateView', 'ItemDetailView', 'ItemUpdateView', 'ItemDeleteView',
        'WarehouseListView', 'WarehouseCreateView', 'WarehouseDetailView', 'WarehouseUpdateView', 'WarehouseDeleteView',
        'SupplierCategoryListView', 'SupplierCategoryCreateView', 'SupplierCategoryDetailView', 'SupplierCategoryUpdateView', 'SupplierCategoryDeleteView',
    ...
    'ReceiptTemporaryRevertConversionView',
        'ReceiptTemporaryRevertConversionView',
        'ReceiptPermanentListView', 'ReceiptPermanentCreateView', 'ReceiptPermanentDetailView', 'ReceiptPermanentUpdateView',
        ...
        'IssuePermanentListView', 'IssuePermanentDetailView', 'IssuePermanentCreateView', 'IssuePermanentUpdateView',
        'IssuePermanentDeleteView', 'IssuePermanentLockView', 'IssuePermanentLineSerialAssignmentView',
        'IssueConsumptionListView', 'IssueConsumptionDetailView', 'IssueConsumptionCreateView', 'IssueConsumptionUpdateView',
        ...
        'IssueWarehouseTransferListView',
        'StocktakingFormMixin',
        'StocktakingDeficitListView', 'StocktakingDeficitCreateView', 'StocktakingDeficitDetailView', 'StocktakingDeficitUpdateView',
        'StocktakingDeficitDeleteView', 'StocktakingDeficitLockView',
        'StocktakingSurplusListView', 'StocktakingSurplusCreateView', 'StocktakingSurplusDetailView', 'StocktakingSurplusUpdateView',
        'StocktakingSurplusDeleteView', 'StocktakingSurplusLockView',
        'StocktakingRecordListView', 'StocktakingRecordCreateView', 'StocktakingRecordDetailView', 'StocktakingRecordUpdateView',
