...
if _views_py_path.exists():
    ...
    _exclude = {
        ...
        'ReceiptTemporaryListView', 'ReceiptTemporaryCreateView', 'ReceiptTemporaryUpdateView',
        'ReceiptTemporaryDeleteView', 'ReceiptTemporaryLockView', 'ReceiptTemporarySendToQCView',
        'ReceiptPermanentListView', 'ReceiptPermanentCreateView', 'ReceiptPermanentUpdateView',
        'ReceiptPermanentDeleteView', 'ReceiptPermanentLockView',
        ...
        'ReceiptConsignmentDeleteView', 'ReceiptConsignmentLockView',
